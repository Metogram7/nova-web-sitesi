...
# ------------------------------------
def get_nova_date():
    # Render sunucusu UTC'dir. Türkiye saati için +3 saat ekliyoruz.
...
async def chat():
    ...
    try:
        ...
        # DÜZELTME: datetime.UTC yerine timezone.utc kullanıldı
